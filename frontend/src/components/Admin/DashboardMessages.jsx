...
const DashboardMessages = () => {
  ...
  return (
    <div className="w-[90%] bg-white m-5 p-4 h-[85vh] overflow-y-scroll hide-scrollbar rounded">
      {!open && (
        <>
...
const MessageList = ({
  ...
  return (
    <div
      className={` rounded mb-3 w-full flex p-3 py-3 ${
        data.seen ? 'bg-transparent' : 'bg-[#0b0a0a10]'
      } cursor-pointer`}
